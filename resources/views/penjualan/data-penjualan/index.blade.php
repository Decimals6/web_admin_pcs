        ...
        <div class="card-header bg-dark text-white">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    {{-- Print --}}
                    <a href="{{ route('penjualan.data-penjualan.print', request()->query()) }}" target="_blank"
            ...
            <form method="GET" class="mb-4">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('penjualan.data-penjualan.index') }}" class="btn btn-secondary">
                            Reset
                        </a>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <a href="{{ route('penjualan.data-penjualan.pdf', request()->query()) }}" target="_blank"
