        ...
        <div class="card-header bg-dark text-white">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    {{-- Print --}}
                    <a href="{{ route('pembelian.data-pembelian.print', request()->query()) }}" target="_blank"
            ...
            <form method="GET" class="mb-4">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('pembelian.data-pembelian.index') }}" class="btn btn-secondary">
                            Reset
                        </a>
                    </div>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    @forelse($invoices as $index => $inv)
                        ...
                        <tr class="{{ $rowClass }} invoice-row" data-id="{{ $inv->id }}" data-no="{{ $inv->no }}"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p>Silakan pilih format export.</p>
                    ...
                    <a href="{{ route('pembelian.data-pembelian.pdf', request()->query()) }}" target="_blank"
